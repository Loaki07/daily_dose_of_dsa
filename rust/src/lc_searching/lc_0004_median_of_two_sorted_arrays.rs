...
impl Solution {
    ...
    pub fn _find_median_sorted_arrays(
        mut nums1: Vec<i32>,
        nums2: Vec<i32>,
    ) -> f64 {
        for val in nums2 {
    ...
    pub fn find_median_sorted_arrays(
        ...
        while left <= right {
            ...
            if base_left <= ref_right
                && ref_left <= base_right
            {
                if total % 2 == 1 {
                    return base_right.min(ref_right);
                } else {
                    return (base_left.max(ref_left)
                        + base_right.min(ref_right))
                        / 2.0;
                }
...
mod tests {
    ...
    #[test]
    fn test_find_median_sorted_arrays_solution1_example1() {
        assert_eq!(
            Solution::_find_median_sorted_arrays(
                vec![1, 3],
                vec![2]
            ),
            2.0
    ...
    #[test]
    fn test_find_median_sorted_arrays_solution1_example2() {
        assert_eq!(
            Solution::_find_median_sorted_arrays(
                vec![1, 2],
                vec![3, 4]
    ...
    #[test]
    fn test_find_median_sorted_arrays_solution2_example1() {
        assert_eq!(
    ...
    #[test]
    fn test_find_median_sorted_arrays_solution2_example2() {
        assert_eq!(
            Solution::find_median_sorted_arrays(
                vec![1, 2],
                vec![3, 4]
